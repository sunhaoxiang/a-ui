...
export default App
`,S={render:a=>{const[u,c]=l.useState(""),r=(s,o=1)=>({value:s.repeat(o)}),n=s=>s?[r(s),r(s,2),r(s,3)]:[],i=s=>{c(s.value)};return t.jsx(b,{...a,value:u,fetchSuggestions:n,onSelect:i,placeholder:"Simple AutoComplete"})},parameters:j({code:Z})},ee=`
import { useState } from 'react'
import { AutoComplete } from '@a-front-end-project/a-ui'
import type { DataSourceType } from '@a-front-end-project/a-ui/types/AutoComplete/autoComplete.d.ts'
...
export default App
`,y={render:a=>{const[u,c]=l.useState(""),r=(o,d=1)=>({value:o.repeat(d),number:Math.floor(Math.random()*1e3)}),n=o=>o?[r(o),r(o,2),r(o,3)]:[],i=o=>{const d=o;return t.jsxs(t.Fragment,{children:[t.jsxs("b",{children:["Name: ",d.value]}),t.jsx("span",{children:" - "}),t.jsxs("span",{children:["Number: ",d.number]})]})},s=o=>{c(o.value)};return t.jsx(b,{...a,value:u,fetchSuggestions:n,placeholder:"Custom AutoComplete",renderOption:i,onSelect:s})},parameters:j({code:ee})},te=`
import { useState } from 'react'
import { AutoComplete } from '@a-front-end-project/a-ui'
import type { DataSourceType } from '@a-front-end-project/a-ui/types/AutoComplete/autoComplete.d.ts'
...
export default App
`,C={render:a=>{const u=r=>fetch(`https://api.github.com/search/users?q=${r}`).then(n=>n.json()).then(({items:n})=>n.slice(0,10).map(i=>({value:i.login,...i}))),c=r=>{const n=r;return t.jsxs(t.Fragment,{children:[t.jsxs("b",{children:["Name: ",n.value]}),t.jsxs("span",{children:["url: ",n.url]})]})};return t.jsx(b,{...a,fetchSuggestions:u,placeholder:"Ajax AutoComplete",renderOption:c})},parameters:j({code:te})};var O,_,E;S.parameters={...S.parameters,docs:{...(O=S.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => {
    const [value, setValue] = useState('');
    const mockVal = (str: string, repeat = 1) => ({
      value: str.repeat(repeat)
...
//# sourceMappingURL=autoComplete.stories-74e25e30.js.map
