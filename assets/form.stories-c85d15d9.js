...
export default App
`,o={render:t=>e.jsxs(r,{...t,children:[e.jsx(r.Item,{label:"Username",name:"Username",rules:[{type:"string",required:!0,min:3}],children:e.jsx(s,{})}),e.jsx(r.Item,{label:"Password",name:"password",rules:[{type:"string",required:!0,min:3,max:8}],children:e.jsx(s,{type:"password"})}),e.jsx("div",{className:"a-form-submit-area",children:e.jsx(d,{type:"submit",btnType:"primary",children:"Login"})})]}),parameters:c({code:T})},k=`
...
}`,...(f=(g=o.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var I,b,x;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => {
    const initialValues = {
      agreement: false
    };
...
//# sourceMappingURL=form.stories-c85d15d9.js.map
